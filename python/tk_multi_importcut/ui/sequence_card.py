...
class Ui_SequenceCard(object):
    def setupUi(self, SequenceCard):
        ...
        self.icon_label.setMinimumSize(QtCore.QSize(0, 48))
        ...
        self.select_button.setMaximumSize(QtCore.QSize(40, 40))
        ...
        self.select_button.setIconSize(QtCore.QSize(40, 40))
