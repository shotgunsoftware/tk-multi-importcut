...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.only_repeated_check_box = QtGui.QCheckBox(self.cut_summary_page)
        self.only_repeated_check_box.setObjectName("only_repeated_check_box")
        self.horizontalLayout_2.addWidget(self.only_repeated_check_box)
        ...
        self.cut_summary_widgets.setGeometry(QtCore.QRect(0, 0, 954, 504))
...
"EDL", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.only_repeated_check_box.setText(QtGui.QApplication.translate("Dialog", "Only Repeated", None, QtGui.QApplication.UnicodeUTF8))
