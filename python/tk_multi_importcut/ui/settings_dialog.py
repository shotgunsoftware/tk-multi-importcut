...
class Ui_settings_dialog(object):
    def setupUi(self, settings_dialog):
        ...
        self.general_timecode_frames_tab.setElideMode(QtCore.Qt.ElideRight)
        ...
        self.general_tab.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.apply_button = QtGui.QPushButton(settings_dialog)
