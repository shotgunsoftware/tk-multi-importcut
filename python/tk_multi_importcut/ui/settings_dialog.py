...
class Ui_settings_dialog(object):
    ...
    def retranslateUi(self, settings_dialog):
        ...
        self.description_1_label.setText(QtGui.QApplication.translate("settings_dialog", "When a new Cut omits a Shot or reinstates a previously-omitted Shot, the app can automatically update the status in ShotGrid.", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.description_2_label.setText(QtGui.QApplication.translate("settings_dialog", "When creating new Shots in ShotGrid, the app will use the following numbers for start frame and handles.", None, QtGui.QApplication.UnicodeUTF8))
