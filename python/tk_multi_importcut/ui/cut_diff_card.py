...
class Ui_CutDiffCard(object):
    def setupUi(self, CutDiffCard):
        ...
        self.shot_name_label = EntityLineEdit(CutDiffCard)
        self.shot_name_label.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse)
...
from ..dialog import EntityLineEdit
