...
"")
        ...
        self.checkBox = QtGui.QCheckBox(submit_dialog)
        self.checkBox.setObjectName("checkBox")
        self.gridLayout.addWidget(self.checkBox, 10, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.import_cut_button_box, 3, 0, 1, 3)
    ...
    def retranslateUi(self, submit_dialog):
        ...
        self.checkBox.setToolTip(QtGui.QApplication.translate("submit_dialog", "If off, Shot fields will not be updated, but, if needed, new Shots will be created", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox.setText(QtGui.QApplication.translate("submit_dialog", "Update Shot Fields", None, QtGui.QApplication.UnicodeUTF8))
